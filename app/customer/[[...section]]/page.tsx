...
export default async function Page({params}:{params:Promise<{section?:string[]}>}){
  ...
  const allowed=["home","discover","recommended","saved","following","recent","bids","pipeline","documents","deadlines","buyers","intelligence","awards","ai","alerts","profile","notifications","help","settings","opportunity"];
