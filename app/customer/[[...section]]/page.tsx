...
export default async function Page({params}:{params:Promise<{section?:string[]}>}){
  ...
  const allowed=["home","discover","bidscope-tenders","recommended","saved","following","recent","bids","pipeline","documents","deadlines","meetings","buyers","intelligence","awards","ai","alerts","profile","team","readiness","billing","notifications","help","settings","opportunity"];
