...
export default async function Page({params}:{params:Promise<{section?:string[]}>}){
  ...
  const allowed=["home","discover","bidscope-tenders","recommended","saved","following","recent","bids","pipeline","documents","deadlines","meetings","messages","buyers","intelligence","awards","ai","alerts","profile","verification","team","readiness","billing","notifications","feedback","help","settings","opportunity"];
