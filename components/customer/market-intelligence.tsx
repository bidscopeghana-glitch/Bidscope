...
export function MarketIntelligence() {
  ...
  const namedSectors = data.sectors.filter(item => item.name !== "Unclassified" && !/^\d+(?:\s*,\s*\d+)*$/.test(item.name));
