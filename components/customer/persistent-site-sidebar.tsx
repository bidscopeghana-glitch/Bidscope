...
export function PersistentSiteSidebar() {
  ...
  const organizations = useData<{ data: Array<{ organization: { can_bid: boolean } }> }>(signedIn ? "/api/organizations" : null);
