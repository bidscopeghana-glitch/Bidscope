...
export type Organization={id:string;name:string;region:string|null;sectors:string[];services:string[];products:string[];certifications:string[];preferred_regions:string[];preferred_minimum_value:number|null;preferred_maximum_value:number|null};
