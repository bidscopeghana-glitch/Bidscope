...
export function ProcurementHeader() {
  return <><header className="sticky top-0 z-40 border-b border-[#084d33]/10 bg-[#fdfbf4]/95 backdrop-blur-xl"><div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 sm:gap-5 sm:px-6 lg:px-8"><Link href="/" aria-label="BidScope home"><BrandLogo priority className="h-auto w-[132px] sm:w-[170px]"/></Link><nav className="ml-auto flex items-center gap-1 text-xs font-semibold text-[#35554a] sm:gap-2 sm:text-sm"><Link className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-2 hover:bg-[#e9f1e8] sm:px-3" href="/live-opportunities"><span className="size-2 rounded-full bg-[#16a36f] shadow-[0_0_0_3px_rgba(22,163,111,.14)]"/>Live</Link><Link className="hidden rounded-full px-3 py-2 hover:bg-[#e9f1e8] md:inline-flex" href="/workspace">Workspace</Link><Link className="hidden rounded-full px-3 py-2 hover:bg-[#e9f1e8] lg:inline-flex" href="/plans">Plans</Link><AuthNav/></nav></div></header><AuthModal/></>;
}
