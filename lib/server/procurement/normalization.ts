...
export function normalize(input: OpportunityInput): NormalizedOpportunity {
  ...
  return {
    ...
    submission_instructions: input.submission_instructions || null, qualification_requirements: input.qualification_requirements || null,
    local_registration_required: input.local_registration_required ?? null, local_partner_required: input.local_partner_required ?? null,
    bid_security_text: input.bid_security_text || input.bid_security_requirement || null,
    required_certifications: input.required_certifications || [], required_documents: input.required_documents || [], source_details: input.source_details || {},
