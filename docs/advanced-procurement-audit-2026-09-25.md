...
| 26 Lot optimiser | Partial foundation: award lots | Added opened-bid, buyer-manager-only lot price comparisons: independent lowest price, cheapest complete single supplier and a greedy diversified allocation; optional budget, minimum suppliers and maximum lots per supplier; audit event and explicit human-review warning | PARTIAL: not a compliance or capacity solver; no regional/SME/technical constraints, exhaustive optimisation, persisted scenario selection or live multi-role acceptance. No automatic award. |
